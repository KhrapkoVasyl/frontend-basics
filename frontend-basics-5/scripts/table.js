//
const MY_NUMBER_IN_STUDENTS_LIST = 61;
const MY_CELL_BY_VARIANT = MY_NUMBER_IN_STUDENTS_LIST % 36;
...
const handleDblClick = (event) => {
  ...
  const cellRawElement = targetCell.parentElement;
  const rawCells = cellRawElement.querySelectorAll('td');
